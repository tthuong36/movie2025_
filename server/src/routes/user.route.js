...
// ⚠️ CẦN ĐẢM BẢO CÓ DÒNG IMPORT NÀY NẾU BẠN DÙNG MIDDLEWARE ADMIN
import adminMiddleware from "../middlewares/admin.middleware.js"; 

const router = express.Router();

// ==========================================================
// 1. CÁC ROUTE CƠ BẢN (SIGNUP, SIGNIN, UPDATE PASSWORD, INFO)
// ==========================================================
router.post(
  "/signup",
  body("username")
...
  body("password")
    .exists().withMessage("password is required"), 
  // Đây là dòng kiểm tra độ dài mật khẩu đã được comment out 
  // .isLength({ min: 8 }).withMessage("password minimum 8 characters"), 
  requestHandler.validate,
